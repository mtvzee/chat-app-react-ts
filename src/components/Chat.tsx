    ...
    <div className="flex-auto flex flex-col">
      ...
      <div className="flex-auto overflow-y-scroll">
        <div className="w-[90%] mx-auto flex flex-col space-y-3 py-4">
          {/* チャット相手のテキスト欄 */}
          <div className="flex items-start space-x-1 w-2/3">
            ...
            <span className="self-end text-sm">12:00</span>
          </div>

          {/* 自分のテキスト欄 */}
          <div className="flex items-end self-end space-x-1 w-2/3 text-justify">
            <span className="self-end text-sm">12:00</span>
